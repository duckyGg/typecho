...
JS;
        ...
        if ($mouseType != 'none') {
            $js .= '<script>';
            $js .= <<<JS
$("html").css("cursor", "url('{$imageDir}/{$mouseType}/normal.cur'), default");
